...
host=$1 ca=$2
for spoof in '' 'Authorization: Bearer invalid' 'X-Elektro-Subject: administrator' 'X-Auth-Request-User: administrator' 'X-Forwarded-User: administrator'; do
  args=()
...
echo 'Anonymous and spoofed requests returned denial/login statuses. Complete the authenticated, backend-header and outage checks in docs/validation.md.'
