...
These checks do not exercise physical Debian installation, Cilium's real LAN/ARP/WireGuard behavior, Longhorn iSCSI and disk recovery, Windows/EdgeOS commands, browser sessions, Google credentials, GPU drivers, or a complete production cluster. Complete the [Windows DNS/TLS checks](windows-clients.md#verify-and-troubleshoot), [L2/BGP checks](bgp.md#addresses-dns-and-acceptance) and following acceptance checks on your hardware before relying on the foundation.
